...
export const RECIEVE_GAMES_COUNT = 'RECIEVE_GAMES_COUNT'
export const RECIEVE_DISCOVER_GAME = 'RECIEVE_DISCOVER_GAME'
export const ADD_EXCLUDED_DISCOVER_GAMES = 'ADD_EXCLUDED_DISCOVER_GAMES'
...
export const ADD_FAVOURITE_GAME_ALL = 'ADD_FAVOURITE_GAME_ALL'
